    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-950 px-4">
          <div className="max-w-md w-full bg-white dark:bg-dark-900 rounded-lg shadow-lg p-8 text-center">
            <div className="mb-6">
              <svg
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/"
                className="block w-full bg-gray-200 dark:bg-dark-800 text-gray-800 dark:text-gray-200 px-6 py-3 rounded-lg font-semibold hover:bg-gray-300 dark:hover:bg-dark-700 transition-colors"
              >
                Go to Home
              </Link>
            </div>
